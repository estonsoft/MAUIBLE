...
namespace MagtekblePos
{
    public partial class MainPage : ContentPage
    {
        ...
        public MainPage()
        {
            ...
            Logger.Default.LogReceived += Logger_LogReceived;
        ...
        private void Logger_LogReceived(LoggerFlags Flags, string Info)
        {
            if (Flags == LoggerFlags.LF_DEVICE)
                sendToOutput("** Device: " + Info);
            else if (Flags == LoggerFlags.LF_COMMUNICATION)
        ...
        private void scanDevices()
        {
            Task task = Task.Factory.StartNew(() =>
            {
                ...
                mDeviceList = CoreAPI.getDeviceList(MTUSDKNET.DeviceType.MMS);
        ...
        private void showDeviceInfo(IDevice device)
        {
            ...
            MTUSDKNET.DeviceInfo deviceInfo = device.getDeviceInfo();
        ...
        private void showSignature(byte[] data)
        {
            ...
            try
            {
                ...
                {
                    Point startPoint = new Point((int)data[0], (int)data[1]);
                    int i = 2;
                    ...
                    while (i < data.Length)
                    {
                        Point endPoint = new Point((int)data[i], (int)data[i + 1]);

                        if ((endPoint.Y != 0xFF) && (startPoint.Y != 0xFF))
                        {
                            Line line = new Line();
                            line.Stroke = new SolidColorBrush(Colors.DarkGray);
                            line.StrokeThickness = 2;
                            line.X1 = startPoint.X / 2 + 200;
                            line.Y1 = startPoint.Y / 2;
                            line.X2 = endPoint.X / 2 + 200;
